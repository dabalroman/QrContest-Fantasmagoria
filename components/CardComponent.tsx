...
export default function CardComponent ({
    ...
    return (
        ...
        >
            <div
                className="bg-card-border text-center text-text-accent absolute top-0 right-0 pb-2 pl-4 pt-0 pr-2
                rounded-bl-3xl"
            >
                <span className="text-2xl font-fancy-capitals block">
            ...
            <div
                className="bg-card-border text-text-accent absolute bottom-0 left-0 pb-2 pl-2 pt-3 pr-4 rounded-tr-3xl">
                <span className="text-2xl font-fancy-capitals">{card.name}</span>
            </div>
        </div>
    );
}
