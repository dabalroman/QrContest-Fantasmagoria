...
export default function RulebookPage () {
    ...
    const topics: string[] = [
        ...
        'Zwycięzca to osoba, która uzyskała odpowiednią ilość punktów do momentu zakończenia danej rundy konkursu. W każdej rundzie troje uczestników z największą ilością punktów uzyska tytuł zwycięzcy oraz nagrody o wartości zależnej od uzyskanego miejsca.',
        ...
        'Uczestnicy nagrodzeni w rundzie pierwszej nie będą brani pod uwagę przy wyłanianiu zwycięzców w rundzie drugiej, jednak mogą nadal brać udział w konkursie w celu uzupełnienia swojej kolekcji kart.',
