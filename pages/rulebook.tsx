...
export default function RulebookPage () {
    ...
    const topics: string[] = [
        ...
        'Uczestnicy nagrodzeni w rundzie pierwszej nie będą brani pod uwagę przy wyłanianiu zwycięzców w rundzie drugiej, jednak mogą nadal brać udział w konkursie w celu zdobywania kolejnych pinów i osiągnięć.',
        ...
        'Aplikacja do celów realizacji konkursu zbiera dane takie jak: adres e-mail lub Google ID uczestnika (zależnie od wybranej metody logowania), Imię/Pseudonim, informacje o zdobytych pinach, informacje o odpowiedziach na pytania oraz przesłane zdjęcia.',
